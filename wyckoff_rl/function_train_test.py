...
def train_split(
    ...
    if is_nq_discrete:
        ...
        env_args = {
            ...
            'tick_size': env_params.get('tick_size', 0.25),
            'tick_value': env_params.get('tick_value', 5.0),
            'max_position_size': env_params.get('max_position_size', 2),
            'reward_scale': env_params.get('reward_scale', 1.0),
            'event_threshold': 0.3,
            'entry_bonus_scale': 0.50,
            'invalid_penalty': 0.02,
            'mgmt_bonus_scale': 0.01,
