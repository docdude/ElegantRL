...
Mirrors cpcv_pipeline/function_train_test.py but for the single-instrument
WyckoffTradingEnv. Key differences:
  ...
  - No VecEnv (single env, single process training)
"""
...
def train_split(
    ...
    2. Creates WyckoffTradingEnv pointing at train NPZ
    3. Trains with ElegantRL's single-process trainer
    ...
    args = Config(agent_class, WyckoffTradingEnv, env_args)
    args.eval_env_class = WyckoffTradingEnv
